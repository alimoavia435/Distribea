...
text-2xl sm:text-3xl md:text-4xl lg:text-5xl xl:text-[56px] text-[22px] 
  ...
  text-[#F7F7F7] m-[25px] lg:mb-24'
        ...
        <p className="flex items-center justify-center gap-2  max-[600px]:text-center text-[16px] sm:text-[18px] md:text-[20px] lg:text-[22px] xl:text-[24px] font-[500] text-[#F7F7F7] tracking-0 leading-[110%]"     style={{ fontFamily: 'Space Grotesk_Medium' }}  >
          🎬 Get the right music for your creation
        </p>
        <p className="text-sm mt-3  max-[600px]:text-center text-[12px] sm:text-[13px] md:text-[14px] lg:text-[15px] xl:text-[16px] font-[400] text-[#94979C] tracking-0 leading-[140%]"    style={{ fontFamily: 'Space Grotesk' }}  >
          Not just background sound. [Your brand] turns every project into a signature experience.
        </p>
      </div>
