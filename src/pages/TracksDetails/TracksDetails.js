    ...
    <div className='bg-[#080808]'>
        ...
        >
          <div className='flex flex-col gap-[15px] lg:gap-[20px] pt-[15px]  items-start'>
            ...
            <p
              ...
              className=' text-[45px] sm:text-[65px] md:text-[85px] lg:text-[100px] xl:text-[128px] leading-[100%] text-[#F9F9F9] tracking-[-1.28px] xl:tracking-[–2.56px]'
            >
              {title || 'Gaming'}
            </p>
            <p
      ...
      <div className='flex flex-col items-center gap-[30px] lg:gap-[48px] px-[0px]'>
        ...
        <div className='w-full overflow-x-auto scrollbar-hide'>
          <div className='min-w-[600px] w-full px-[15px] md:px-[25px] flex flex-col gap-[20px] lg:gap-[24px]  max-[600px]:gap-[12px]'>
            {tracks?.map((track, index) => (
              ...
              >
                ...
                <div className='flex items-start gap-[8px] sm:gap-[10px] md:gap-[20px] w-full max-w-[170px]'>
                  <img
                    src={track.image}
                    alt={track.title}
                    className='w-[50px] h-[50px] lg:w-[60px] lg:h-[60px] rounded-md object-cover'
                  />
                  <div>
                    <h3
                    ...
                    <p
                      ...
                      className=' text-[#F9F9F9] text-[11px] lg:text-[13px] opacity-70'
                    >
                      {track.duration}
                    </p>
                  </div>
                ...
                {/* Right section */}
                <div className='flex items-center max-[470px]:gap-[10px]  gap-6 max-[768px]:w-full max-[768px]:justify-between'>
                  <div
                    style={{ fontFamily: 'Space Grotesk' }}
                    className=' text-[#F9F9F9] text-[11px] lg:text-[13px] opacity-70'
                  >
    ...
    flex justify-center flex-col gap-5 lg:gap-[64px]'
      >
        ...
        <div className='w-full flex items-center justify-between'>
          <p
            className='text-[25px] lg:text-[30px] xl:text-[36px] font-[500] text-[#F9F9F9] tracking-[-1px] leading-[110%]'
            style={{ fontFamily: 'Space Grotesk_Medium' }}
          >
            Related.
          </p>
          <p
            className='text-[10px] sm:text-[11px] md:text-[12px] lg:text-[13px] xl:text-[14px] font-[400] text-[#FAFAFACC] tracking-[-1px] leading-[140%]'
