...
const Culture = () => {
  const categories = [
    ...
    { title: 'Bachata', name: 'Dominican Republic', img: '/Images/mine/l9.png' },
  ...
  const categories1 = [
    ...
    { title: 'Chinese Traditional',name: 'Asian', img: '/Images/mine/ll4.png' },
    { title: 'Thai Traditional Music',name: 'Thailand', img: '/images/mine/ll5.png' },
  ]
   ...
   const categories4 = [
    ...
    { title: 'Viennese Classical', name: 'Austria', img: '/Images/mine/lll10.png' }
  ]
 ...
 const categories5 = [
    ...
    { title: 'Arabic Maqam', name: 'Middle East', img: '/Images/mine/llll9.png' },
